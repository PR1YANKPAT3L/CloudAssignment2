...
(function () {
    ...
    app.run(['$rootScope', '$window', 'FacebookService', '$cookies', '$state', function($rootScope, $window, FacebookService, $cookies, $state) {
      ...
      FB.init({
		...
		app.controller('DashboardController', ['$rootScope', '$scope', '$http', '$timeout', '$cookies', '$state', 'FacebookService', function($rootScope, $scope, $http, $timeout, $cookies, $state, FacebookService) {
